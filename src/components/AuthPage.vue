          ...
          <div class="formBx">
            <form autocomplete="off" action="#" @submit.prevent="login({ email: signinMail, password: inPass })">
              ...
              <p class="signup">
                ...
                <a href="#" @click.prevent="toggleForm(true)">Sign up.</a>
              </p>
            </form>
          </div>
        </div>
        ...
        <div class="imgBx">
          <div class="formBx">
            <form autocomplete="off" action="#" @submit.prevent="signup({ name: upName, email: upEmail, password: upPass })">
              ...
              <input type="password" placeholder="Password" v-model="upPass">
          ...
          <img class="img" src="@/assets/keys.jpg" alt="">
        </div>
      </div>
...
.signupBx .imgBx .formBx form button {
  background: #e73e49;
}
...
.container.active .signupBx .imgBx .img {
  top: 0;
}
